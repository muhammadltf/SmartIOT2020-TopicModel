...
\title{Analysis on the usage of Topic Model with Background Knowledge inside Specific-themed Discussion Activiy}
...
\begin{abstract}
Kontol Kontol Kontol Kontol Kontol Kontol.
